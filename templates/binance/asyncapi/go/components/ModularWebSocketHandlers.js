...
func (c *Client) HandleEventStreamTerminated(handler func(event *models.EventStreamTerminated) error) {
	// Empty implementation - should be generated by WebSocketHandlers
}

func (c *Client) HandleOutboundAccountPosition(handler func(event *models.OutboundAccountPosition) error) {
	// Empty implementation - should be generated by WebSocketHandlers  
}

func (c *Client) HandleBalanceUpdate(handler func(event *models.BalanceUpdate) error) {
	// Empty implementation - should be generated by WebSocketHandlers
}

func (c *Client) HandleExecutionReport(handler func(event *models.ExecutionReport) error) {
	// Empty implementation - should be generated by WebSocketHandlers
}

func (c *Client) HandleListStatus(handler func(event *models.ListStatus) error) {
	// Empty implementation - should be generated by WebSocketHandlers
}

func (c *Client) HandleListenKeyExpired(handler func(event *models.ListenKeyExpired) error) {
	// Empty implementation - should be generated by WebSocketHandlers
}

func (c *Client) HandleExternalLockUpdate(handler func(event *models.ExternalLockUpdate) error) {
	// Empty implementation - should be generated by WebSocketHandlers
}`;
}
